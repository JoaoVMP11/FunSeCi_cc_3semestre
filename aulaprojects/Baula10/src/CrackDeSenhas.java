...
public class CrackDeSenhas {
	...
	public static void procurarUsuario(String senha) {
	String usuario = mapaDeSenhas.get(calcularHash(senha));
	if (usuario != null) {
		System.out.println("ACHEI PORRA !!!! " + usuario + " -> " + senha);
		}
	}
	...
	public static void main(String[] args) {
		...
		new AtaqueNumerico().start();
		new AtaqueAlfabeticoMinusculoQuatroLetras().start();
		new AtaqueAlfabeticoMinusculoCincoLetras().start();
		new AtaqueAlfabeticoMinusculoSeisLetras().start();
	}
}
