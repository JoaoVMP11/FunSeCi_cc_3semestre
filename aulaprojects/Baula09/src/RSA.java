...
public class RSA {
	...
	private static byte[] decriptarRSA(String cifra, KeyPair parDeChaves) throws Exception{
		...
		return Base64.getDecoder().decode(cifra);
	}
	...
	private static byte[] gerarChaveSimetrica() throws Exception {
	...
	public static void main(String[] args) {
		...
		try {
			...
			byte[] chaveSimetrica = gerarChaveSimetrica();
			...
			System.out.println(decriptarAES(cifraTexto, calcularSHA256(decriptarRSA(cifraChave, parDeChavesAssimetricas))));
